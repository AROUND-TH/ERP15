...
{
    'name': 'Stock Inventory Aging and Breakdown Reports Odoo',
    'version': '14.0.0.0',
    'category': 'Warehouse',
    'summary': 'Print Inventory Age Report and Inventory Breakdown Report inventory aging report stock aging report warehouse aging report stock break down report warehouse break down report product Stock aging report Inventory age stock report stock card stock Break down',
    'description': """
    ...
    'depends': ['stock','sale','account','purchase','sale_stock', 'stock_account'],
    'data': [
        'security/ir.model.access.csv',
        'views/inventory_age_wizard_view.xml', 
        'views/inventory_breakdown_wizard_view.xml',

    ],
    'live_test_url':'https://youtu.be/SBu1c6yp2jw',
    'price': 69,
    'currency': "EUR",
    'demo': [],
    'test': [],

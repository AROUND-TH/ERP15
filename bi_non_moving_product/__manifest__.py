...
{
    'name': ' Dead stock and slow non moving product stock reports in odoo ',
    'version': '14.0.0.0',
    'category': 'Warehouse',
    'price': '',
    'currency': "",
    'summary': 'Product Dead stock report non moving product report Expiry stock report Stock Aging report aging report stock aging report product overstock report Inventory stock Age Breakdown Inventory Turnover report Stock turnover reports inventory turnover reports',
    'description': """
    This modules helps to print unsold products for specific period.
    odoo print stock aging reports Non Moving Products reports Dead stock and slow non moving product stock reports in odoo
    odoo Non Moving material analysis report non moving product report Inventory Quantity Movement reports Non Moving Inventory from reports
    odoo dead stock report dead stock Non-Moving Products reports slow moving inventory report slow moving stock report non-moving product report 
    odoo product aging reports products aging reports product stock aging reports
...
Generate Excel Report for All Warehouses Stock and Particular Warehouses Stock Between Specific Dates.
    ...
    odoo print stock expired report print product expired report product 
    odoo unsold products reports unsold product reports unsold product for specific period unsold product reports for last month remaining stock reports
    """,
    "price": 25.00,
    "currency": 'EUR',
    'author': 'BrowseInfo',
    ...
    'data': [
        ...
        'views/non_moving_view_wizard.xml',
    ],
    'live_test_url':'https://youtu.be/OQBK7JGy6uQ',
    'demo': [],
    'test': [],
    'installable': True,
    'auto_install': False,

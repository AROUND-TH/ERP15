...
class StockPicking(models.Model):
    ...
    def _get_partner_to_invoice(self, picking):
        ...
        """
        if picking.sale_id:
            return picking.sale_id.partner_invoice_id.id
        elif picking.purchase_id:
            return picking.purchase_id.partner_id.id
        else:
            return picking.partner_invoice_id and picking.partner_invoice_id.id
    ...
    def _invoice_create_line(self, moves, journal_id, inv_type='out_invoice'):
        ...
        for move in moves:
            ...
            invoice_line_vals['sale_line_id'] = move.sale_line_id
...
class stock_move(models.Model):
    ...
    def _get_master_data(self, move, company):
        ...
        if move.picking_id.sale_id:
            ...
            partner = move.picking_id and move.picking_id.partner_invoice_id
